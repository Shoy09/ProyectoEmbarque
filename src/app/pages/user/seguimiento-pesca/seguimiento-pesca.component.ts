...
export class SeguimientoPescaComponent {
  ...
  displayedColumns: string[] = [ 'flotaDP_id', 'embarcacion', 'fecha', 'zona_pesca','numero_alcance','especie',  'estrato', 'profundidad', 'tiempo_efectivo', 'rango_talla_inicial', 'rango_talla_final','moda', 'porcentaje', 'ar', 'numero', 'acciones'];
